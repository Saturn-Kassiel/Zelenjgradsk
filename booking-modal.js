        ...
        '<div id="bm-form-screen">' +
          ...
          '<div class="bm-row-dates">' +
            '<div style="min-width:0;width:100%;box-sizing:border-box"><label style="font-size:11px;font-weight:600;letter-spacing:1px;text-transform:uppercase;color:#6B7A99;display:block;margin-bottom:6px">Дата заезда <span style="color:#E05252">*</span></label>' +
              '<input id="bm-checkin" type="date" oninput="this.style.borderColor=\'\'" onchange="BookingModal._recalc();BookingModal._calRender()" style="width:100%;max-width:100%;box-sizing:border-box;padding:11px 14px;border:1.5px solid #E1E5F1;border-radius:12px;font-family:DM Sans,sans-serif;font-size:14px;outline:none"></div>' +
            '<div style="min-width:0;width:100%;box-sizing:border-box"><label style="font-size:11px;font-weight:600;letter-spacing:1px;text-transform:uppercase;color:#6B7A99;display:block;margin-bottom:6px">Дата выезда</label>' +
              '<input id="bm-checkout" type="date" readonly style="width:100%;max-width:100%;box-sizing:border-box;padding:11px 14px;border:1.5px solid #E1E5F1;border-radius:12px;font-family:DM Sans,sans-serif;font-size:14px;outline:none;background:#F4F6FB;color:#6B7A99"></div>' +
          '</div>' +
