  ...
  return {
    ...
    _sendChatMessage: function(name, dateIn, dateOut, nights, amount, breakdown, nWord, comment) {
      ...
      if (typeof cwAddMsg === 'function') {
        ...
        setTimeout(function(){
          cwAddMsg('Укажите, пожалуйста, предпочтительный способ связи с вами: телефон, WhatsApp, Telegram или другой.\n\nОтправляя контакт, вы подтверждаете согласие на [обработку персональных данных](https://aparts-baltika.ru/privacy.html).', 'bot');
        }, 800);
      }
