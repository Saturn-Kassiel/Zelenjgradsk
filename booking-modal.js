      ...
      '</style>' +
        ...
        '<div id="bm-form-screen">' +
          ...
          '<div class="bm-row-dates">' +
            '<div style="overflow:hidden;min-width:0"><label style="font-size:11px;font-weight:600;letter-spacing:1px;text-transform:uppercase;color:#6B7A99;display:block;margin-bottom:6px">Дата заезда <span style="color:#E05252">*</span></label>' +
            ...
            '<div style="overflow:hidden;min-width:0"><label style="font-size:11px;font-weight:600;letter-spacing:1px;text-transform:uppercase;color:#6B7A99;display:block;margin-bottom:6px">Дата выезда</label>' +
