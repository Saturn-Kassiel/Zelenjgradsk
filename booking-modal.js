  ...
  function getHTML() {
    return '<div id="bm-overlay" style="display:none;position:fixed;inset:0;z-index:9000;background:rgba(46,56,77,0.45);backdrop-filter:blur(6px);align-items:center;justify-content:center;padding:20px;overflow-y:auto" onclick="BookingModal._bgClose(event)">' +
      ...
      '<style>' +
        ...
        '#bm-modal input[type="date"] { -webkit-appearance:textfield; -moz-appearance:textfield; appearance:textfield; min-width:0; width:100%; box-sizing:border-box; }' +
        ...
        '<div id="bm-form-screen">' +
          ...
          '<div class="bm-row-dates">' +
            '<div><label style="font-size:11px;font-weight:600;letter-spacing:1px;text-transform:uppercase;color:#6B7A99;display:block;margin-bottom:6px">Дата заезда <span style="color:#E05252">*</span></label>' +
              '<input id="bm-checkin" type="date" oninput="this.style.borderColor=\'\'" onchange="BookingModal._recalc();BookingModal._calRender()" style="width:100%;max-width:100%;box-sizing:border-box;padding:11px 14px;border:1.5px solid #E1E5F1;border-radius:12px;font-family:DM Sans,sans-serif;font-size:14px;outline:none;-webkit-appearance:none;appearance:none"></div>' +
            '<div><label style="font-size:11px;font-weight:600;letter-spacing:1px;text-transform:uppercase;color:#6B7A99;display:block;margin-bottom:6px">Дата выезда</label>' +
              '<input id="bm-checkout" type="date" readonly style="width:100%;max-width:100%;box-sizing:border-box;padding:11px 14px;border:1.5px solid #E1E5F1;border-radius:12px;font-family:DM Sans,sans-serif;font-size:14px;outline:none;background:#F4F6FB;color:#6B7A99;-webkit-appearance:none;appearance:none"></div>' +
          '</div>' +
